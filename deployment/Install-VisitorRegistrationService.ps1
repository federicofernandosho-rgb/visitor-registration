...
& $NssmPath set $ServiceName DisplayName "Visitor Registration" | Out-Null
& $NssmPath set $ServiceName Description "Visitor Registration Node.js web application" | Out-Null
